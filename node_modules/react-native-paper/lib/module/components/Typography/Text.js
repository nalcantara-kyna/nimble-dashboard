...
import { Text as NativeText, StyleSheet, I18nManager } from 'react-native';
...
const Text = (_ref, ref) => {
  ...
  if (theme.isV3 && variant) {
    ...
    const font = !theme.isV3 ? (_theme$fonts = theme.fonts) === null || _theme$fonts === void 0 ? void 0 : _theme$fonts.regular : {};
